        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Ministra</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card">
                                ...
                                <div class="card-body ">
                                    <form name="curso" action="./pagina/cadastrar/Cadastrar_Ministra.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                ...
                                                <select name="matricula" class="form-control">
                                                    <?php
                                                        ...
                                                        $result = mysqli_query($link, "SELECT matricula FROM Ministra");
                                                        $cont = 1;
                                            ...
                                            <div class="form-group col-md-2">
                                                <label for="inputDevice">Semestre</label>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <a class="dropdown-item" href="./pagina/exibir/Exibir_Ministra.php" style="display: contents;"><button type="button" class="btn btn-primary">Visualizar Cadastros</button></a>
                                            </div>

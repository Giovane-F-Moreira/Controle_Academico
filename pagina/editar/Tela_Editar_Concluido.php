                            ...
                            <div class="card easion-card">
                                ...
                                <div class="card-body ">
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM Concluido WHERE codDisciplina = $codDisciplina AND matricula = $id";

                                        $dados = mysqli_query($conn, $sql);
                                        $linha = mysqli_fetch_assoc($dados);

                                    ?>
                                    <form name="nota" action=".././editar/processar/Editar_Concluido.php" method="POST">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="" class="form-control" name="nota" value="<?php echo $linha['nota'] ?>" step="0.01">
                                            </div>
                                            <div class="container-fluid">

        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Departamento</h1>
                            ...
                            <div class="card easion-card">
                                ...
                                <div class="card-body ">
                                    <?php 
                                        ...
                                        $id = $_GET['id'] ?? '';
                                        $sql = "SELECT * FROM Departamento WHERE codDepart =  $id";
                                        $dados = mysqli_query($conn, $sql);
                                        $linha = mysqli_fetch_assoc($dados);
                                    ?>
                                    <form name="departamento" action="../editar/processar/Editar_Departamento.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="">Nome</label>
                                                <input type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $linha['nome'] ?>" required>
                                                <input type="hidden" name="id" value="<?php echo $linha['codDepart'] ?>">
                                            </div>
                                        </div>
                                        <div class="container-fluid">
                                            <button type="submit" class="btn btn-primary">Salvar</button> 
                                            <a class="dropdown-item" href="../exibir/Exibir_Departamento.php" style="display: contents;"><button type="button" class="btn btn-primary">Visualizar Cadastros</button></a>
                                        </div>
                                    </form>
                                </div>   
                            </div>

...
<head>
    ...
    <title>Academic - Disciplina</title>
</head>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Disciplina</h1>
                        ...
                        <div class="col-xl-12">
                            <div class="card easion-card">
                                ...
                                <?php 
                                        ...
                                        $id = $_GET['id'] ?? '';
                                        $sql = "SELECT * FROM Disciplina WHERE codDisciplina =  $id";
                                        $dados = mysqli_query($conn, $sql);
                                        $linha = mysqli_fetch_assoc($dados);
                                ?>
                                <form name="disciplina" action="../editar/processar/Editar_Disciplina.php" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="">Nome</label>
                                            <input type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $linha['nome'] ?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Semestre</label>
                                            <input type="text" class="form-control" name="semestre" placeholder="Semestre" value="<?php echo $linha['semestre'] ?>" required>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="">Carga Horária</label>
                                            <input type="number" class="form-control" name="cargaHoraria" value="<?php echo $linha['cargaHoraria'] ?>" required>
                                        </div>
                                        <input type="hidden" name="codDisciplina" value="<?php echo $linha['codDisciplina'] ?>">
                                        <div class="container-fluid">
                                            <button type="submit" class="btn btn-primary">Salvar</button> 
                                            <a class="dropdown-item" href="../../pagina/exibir/Exibir_Disciplina.php" style="display: contents;"><button type="button" class="btn btn-primary">Visualizar Cadastros</button></a>
                                        </div>

...
<head> 
    ...
    <title>Academic - Matrícula</title>
</head>
...
<body>
    <div class="dash">
        ...
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="../../index.html" class="easion-logo"><i class="fas fa-cog"></i><span>Ac@demic</span></a>
            </header>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Matricula</h1>
                            ...
                            <div class="card easion-card">
                                ...
                                <div class="card-body ">
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM Matriculado WHERE matricula = $id AND codDisciplina =  $codDisciplina";
                                        $dados = mysqli_query($conn, $sql);
                                        $linha = mysqli_fetch_assoc($dados);
                                    ?>
                                    <form name="matricula" action=".././editar/processar/Editar_Matricula.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputDevice">Matricula</label>
                                                <select name="matricula" class="form-control" required>
                                                    <option value="<?php echo $linha['matricula'] ?>" selected><?php echo $linha['matricula'] ?></option>
                                                    <option value="20183170">20183170</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputDevice">Disciplina</label>
                                                <select name="codDisciplina" class="form-control">
                                                    <option value="<?php echo $linha['codDisciplina'] ?>" selected><?php echo $linha['codDisciplina'] ?></option>
                                                    <option value="2" >Logica de programação 2</option>
                                            ...
                                            <input type="hidden" name="oldMatricula" value="<?php echo $linha['matricula'] ?>">
                                        </div>
                                        <div class="container-fluid">
                                            <button type="submit" class="btn btn-primary">Salvar</button> 
                                            <a class="dropdown-item" href="../../pagina/exibir/Exibir_Matricula.php" style="display: contents;"><button type="button" class="btn btn-primary">Visualizar Cadastros</button></a>
                                        </div>
                                    </form>
                                </div>   
                            </div>
    ...
    <script>
        ...
        function teste(){   
            var nameDevice = $("#inputNameDevice").val();

...
<head>
    ...
    <title>Academic - Professor</title>
</head>
...
<body>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Professor</h1>
                        ...
                        <div class="col-xl-12">
                            <div class="card easion-card">
                                ...
                                <div class="card-body ">
                                    ...
                                    ?>
                                    <form name="professor" action="../editar/processar/Editar_Professor.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                <label for="">Matricula</label>
                                                <input type="text" class="form-control" name="matricula" placeholder="Matricula" value="<?php echo $linha['matricula'] ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="titulacao" placeholder="Titulação" value="<?php echo $linha['titulacao'] ?>">
                                            </div>
                                            <input type="hidden" name="id" value="<?php echo $linha['matricula'] ?>">
                                            <div class="container-fluid">
                                                <button type="submit" class="btn btn-primary">Salvar</button> 
                                                <a class="dropdown-item" href="../../pagina/exibir/Exibir_Professor.php" style="display: contents;"><button type="button" class="btn btn-primary">Visualizar Cadastros</button></a>
                                            </div>
    ...
    <script>
        ...
        function teste(){   
            ...
            if(nameDevice == "" ||  model == "" || nameDevice == null || model == null){

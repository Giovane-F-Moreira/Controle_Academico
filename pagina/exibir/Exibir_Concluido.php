                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card"> 
                                ...
                                <div class="card-body ">
                                    <table class="table table-striped table-in-card">
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM Concluido");
                                            ...
                                            while($dados =  mysqli_fetch_array($result)){    
                                                ...
                                                echo   "<tr>
                                                            ...
                                                            <td>$matricula</td>
                                                            <td>$nota</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Concluido.php?id=$matricula&codDisciplina=$codDisciplina'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                    <a class="dropdown-item" href="../../Cadastrar_Concluido.php"><button type="submit" class="btn btn-primary">Cadastrar</button></a> 
                                </div><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Concluido.php" method="POST">

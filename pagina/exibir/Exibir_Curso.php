                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card"> 
                                ...
                                <div class="card-body ">
                                    <table class="table table-striped table-in-card">
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM Curso");
                                            
                                            while($dados =  mysqli_fetch_array($result)){    
                                                $id = $dados['codCurso'];
                                                $nome = $dados['nome'];
                                                $departamento = $dados['codDepart'];
                                                
                                                echo   "<tr>
                                                            <td>$id</td>
                                                            <td>$nome</td>
                                                            <td>$departamento</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Curso.php?id=$id'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                <a class="dropdown-item" href="../../Cadastrar_Curso.html"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Curso.php" method="POST">

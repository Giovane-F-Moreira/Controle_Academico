        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Disciplinas</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card"> 
                                        ...
                                        <?php 
                                            ...
                                            while($dados =  mysqli_fetch_array($result)){    
                                                ...
                                                echo   "<tr>
                                                            ...
                                                            <td>$semestre</td>
                                                            <td>$cargaHoraria</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Disciplina.php?id=$id'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                <a class="dropdown-item" href="../../Cadastrar_Disciplina.html"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                            <form name="curso" action="../excluir/Excluir_Disciplina.php" method="POST">

...
<head>
    ...
    <title>Academic - Matricula</title>
</head>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Matriculas</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card"> 
                                ...
                                <div class="card-body ">
                                    <table class="table table-striped table-in-card">
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM Matriculado");
                                            ...
                                            while($dados =  mysqli_fetch_array($result)){    
                                                ...
                                                echo   "<tr>
                                                            <td>$matricula</td>
                                                            <td>$codDisciplina</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Matricula.php?id=$matricula&codDisciplina=$codDisciplina'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                <a class="dropdown-item" href="../.././Cadastrar_Matricula.html"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Matricula.php" method="POST">

...
<head>
    ...
    <title>Academic - Disciplinas Ministradas</title>
</head>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Disciplinas Ministradas</h1>
                            ...
                            <div class="card easion-card"> 
                                ...
                                <div class="card-body ">
                                    <table class="table table-striped table-in-card">
                                        <thead>    
                                            <tr>
                                                <th scope="col">Matricula Prof.</th>
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM Ministra");
                                            ...
                                            while($dados =  mysqli_fetch_array($result)){    
                                                ...
                                                echo   "<tr>
                                                            ...
                                                            <td>$ano</td>
                                                            <td>$semestre</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Ministra.php?id=$matricula&codDisciplina=$codDisciplina'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                    <a class="dropdown-item" href="../../Cadastrar_Ministra.php"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                                </div><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Ministra.php" method="POST">

...
<head>
    ...
    <title>Academic - Pre-requisisto</title>
</head>
                            ...
                            <div class="card easion-card"> 
                                ...
                                <div class="card-body ">
                                    <table class="table table-striped table-in-card">
                                        <thead>    
                                            <tr>
                                                <th scope="col">CodDisciplina</th>
                                                <th scope="col">CodPre-Requisito</th>
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM Prerequisito");
                                            
                                            while($dados =  mysqli_fetch_array($result)){    
                                                $codDisciplina = $dados['codDisciplina'];
                                                $codPrerequisito = $dados['codPrerequisito'];
                                                
                                                echo   "<tr>
                                                            <td>$codDisciplina</td>
                                                            <td>$codPrerequisito</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Pre-Requisito.php?id=$codPrerequisito&codDisciplina=$codDisciplina'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                <a class="dropdown-item" href="../../Cadastrar_Pre-Requisito.php"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Pre-Requisito.php" method="POST">
                                    <input type="hidden" name="codDisciplina" value="<?php echo $codDisciplina ?>"> 
                                    <input type="hidden" name="codPrerequisito" value="<?php echo $codPrerequisito ?>">

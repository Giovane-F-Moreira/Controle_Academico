                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card easion-card"> 
                                        ...
                                        <?php 
                                            ...
                                            while($dados =  mysqli_fetch_array($result)){    
                                                ...
                                                echo   "<tr>
                                                            ...
                                                            <td>$nome</td>
                                                            <td>$titulacao</td>
                                                            <td><a href='../../pagina/editar/Tela_Editar_Professor.php?id=$matricula'><i class='fa fa-edit'></i></a></td>
                                ...
                                <div class="container-fluid">
                                    <a class="dropdown-item" href="../../Cadastrar_Professor.html"><button type="submit" class="btn btn-primary">Cadastrar</button></a> 
                                </div><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Professor.php" method="POST">

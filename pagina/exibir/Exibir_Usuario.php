        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Usuários</h1>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-header">
                                        ...
                                        <table class="table table-striped table-in-card">
                                            <thead>    
                                                <tr>
                                                    ...
                                                    <th scope="col-xl-2">Email</th>
                                                    <th scope="col">Senha</th>
                                                    <th scope="col-xl-2">Permissão</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php 
                                                ...
                                                while($dados =  mysqli_fetch_array($result)){    
                                                    ...
                                                    echo   "<tr>
                                                                ...
                                                                <td>$senha</td>
                                                                <td>$permissao</td>
                                                                <td><a href='../../pagina/editar/Tela_Editar_Usuario.php?id=$id'><i class='fa fa-edit'></i></a></td>
                                    ...
                                    <div class="container-fluid">
                                    <a class="dropdown-item" href="../../Cadastrar_Usuario.html"><button type="submit" class="btn btn-primary">Cadastrar</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="curso" action="../excluir/Excluir_Usuario.php" method="POST">
